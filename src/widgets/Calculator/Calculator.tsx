...
import { CAR_AGE, CURRNECY_CODE,  VEHICLE_OWNER_TYPE } from "@/shared/constants/calculatorOptions";
...
const Calculator: React.FC = () => {
  const { control, handleSubmit, formState: { errors } } = useForm<CalculatorFormData>({
    defaultValues: {
      age: "",
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className={styles.flexRow}>
            ...
            <div className={styles.formField}>
              ...
              />
              {errors.age && <div className={styles.errorText}>{errors.age.message}</div>}
              {!errors.age && <div className={styles.errorText}>Обязательное поле</div>}
            </div>
            ...
            <div className={styles.formField}>
              ...
              {!errors.price && <div className={styles.errorText}>Обязательное поле</div>}
            </div>
            ...
            <div className={styles.formField}>
              ...
              />
              {errors.currency && <div className={styles.errorText}>{errors.currency.message}</div>}
              {!errors.currency && <div className={styles.errorText}>Обязательное поле</div>}
            </div>
          </div>
          ...
          <div className={styles.flexRow}>
            ...
            <div className={styles.formField}>
              ...
              />
              {errors.engineType && <div className={styles.errorText}>{errors.engineType.message}</div>}
              {!errors.engineType && <div className={styles.errorText}>Обязательное поле</div>}
            </div>
            ...
            <div className={styles.formField}>
              ...
              />
              {errors.engineCapacity && <div className={styles.errorText}>{errors.engineCapacity.message}</div>}
              {!errors.engineCapacity && <div className={styles.errorText}>Обязательное поле</div>}
            </div>
            ...
            <div className={styles.formField}>
              ...
              />
              {errors.power && <div className={styles.errorText}>{errors.power.message}</div>}
              {!errors.power && <div className={styles.errorText}>Обязательное поле</div>}
            </div>
          </div>
          
          <div className={styles.flexRow}>
            {/* Тип владельца */}
            <div className={styles.formField + ' ' + styles.ownerTypeField}>
              <Controller
                name="ownerType"
                control={control}
                rules={{ required: "Обязательное поле" }}
              ...
              />
              {errors.ownerType && <div className={styles.errorText}>{errors.ownerType.message}</div>}
              {!errors.ownerType && <div className={styles.errorText}>Обязательное поле</div>}
            </div>
